...
def get_args_parser():
    ...
    parser.add_argument('--coco_path', type=str, default='/home/yehcl/Desktop/r11945037cvpdl_hw/jupyter/r11945037_cvpdl_hw1/DINO/hw1_dataset')
    ...
    parser.add_argument('--test_checkopint', help='load from other checkpoint')
...
def main(args):
    ...
    if args.test:
        result = test(model, args.test_path, args.config_file, args.test_checkopint)
